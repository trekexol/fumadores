...
public static void main(String args[]) throws IOException, InterruptedException{
    ...
    while(true){
        Boolean txt = JOptionPane.showConfirmDialog(null, "Quieres buscar ingredientes?","Fumador 2",JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION;
        if(!txt){
    ...
    //buscar en mesa 1
        ...
        respuesta_mesa = Conexion.buscarEnMesa1(2,le_falta);
        ...
        //buscar en mesa 2
        System.out.println("busca en mesa "+(contador_intentos+1));
        respuesta_mesa = Conexion.buscarEnMesa2(2,le_falta);
        System.out.println("respuesta de la mesa :"+respuesta_mesa);
        if(respuesta_mesa.equals("Tabaco")){
              if(le_falta.equals("Tabaco")){
                System.out.println("Completo todos los Ingredientes, empieza a fumar");
...
//buscar en mesa 3
        System.out.println("busca en mesa "+(contador_intentos+1));
        respuesta_mesa = Conexion.buscarEnMesa3(2,le_falta);
        System.out.println("respuesta de la mesa :"+respuesta_mesa);
        if(respuesta_mesa.equals("Tabaco")){
              if(le_falta.equals("Tabaco")){
                System.out.println("Completo todos los Ingredientes, empieza a fumar");
